            ...
            <div className="container mx-auto max-w-6xl">
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="mt-10 grid grid-cols-4 gap-8 sm:grid-cols-8 sm:px-8 lg:grid-cols-12 xl:px-0">
                        <div className="relative col-span-4 flex flex-col items-center justify-between space-y-4 overflow-hidden bg-gray-100 px-8 py-12 sm:rounded-xl">
                        ...
                        <div className="col-span-4 flex flex-col items-center justify-between space-y-4 bg-gray-100 px-8 py-12 sm:rounded-xl">
                            <div className="rounded-full bg-green-500 p-3 text-white">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-8 w-8 "
